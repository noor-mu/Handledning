...
public class StepDefinitions {
	...
	public void i_should_be_signed_up(String string) {

		String text = driver.findElement(By.className("invalid-error")).getText();
		assertEquals(text, "Another user with this username already exists. Maybe it's your evil twin. Spooky.");
		
		String text2 = driver.findElement(By.className("invalid-error")).getText();
		assertEquals(text2, "Enter a value less than 100 characters long");
		
		String text3 = driver.findElement(By.className("invalid-error")).getText();
		assertEquals(text3, "Please enter a value");
